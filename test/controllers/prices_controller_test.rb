...
class PricesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create price" do
    assert_difference('Price.count') do
      post prices_url, params: { price: { component_id: @price.component_id, cost_each: @price.cost_each, qty: @price.qty, shipping_each: @price.shipping_each } }
    end
  ...
  test "should update price" do
    patch price_url(@price), params: { price: { component_id: @price.component_id, cost_each: @price.cost_each, qty: @price.qty, shipping_each: @price.shipping_each } }
